...
class SignUpController: AuthenticationBaseController{
    ...
    func setUpView(){
       ...
       // AppLogoImg.setUpAppLogo(img: AppLogoImg.image!, inset: 60)
       // AppLogoImg.layer.borderWidth = 2
       // AppLogoImg.layer.borderColor = UIColor.veryLightGray.cgColor
      // AppLogoImg.layer.borderColor = UIColor.lightBlue.withAlphaComponent(0.1).cgColor
        ...
        NotificationCenter.default.addObserver(self,
            selector: #selector(SignUpController.receiveToggleAuthUINotification(_:)),
