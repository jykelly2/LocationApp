...
class SavedController: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource, UITableViewDelegate, UITableViewDataSource, EditListDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        setDefaultTitleNavigationBar(navTitle: "Saved", backText: "")
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard !(empty), let listController = storyboard?.instantiateViewController(withIdentifier: "ListMapController") as? ListMapController else { return }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return  traitCollection.userInterfaceIdiom == .pad ? CGSize(width: view.frame.height * 0.21, height: view.frame.height * 0.21) : CGSize(width: view.frame.width * 0.4, height: view.frame.width * 0.429)
    }
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, minimumLineSpacingForSectionAt section: Int) -> CGFloat {
        return traitCollection.userInterfaceIdiom == .pad ? 20 : 10
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard let listController = storyboard?.instantiateViewController(withIdentifier: "ListMapController") as? ListMapController else { return }
    ...
    func didTapEdit(_ tag: Int) {
        ...
        let actionSheetController: UIAlertController = UIAlertController(title: "Select an action:", message: nil, preferredStyle: .actionSheet)
