...
**This app is innovative and unique since there is no exising application that has search ability using user's traced path. So far Apple and Google maps have only have the ability to search for places along the way from point A to B in the navigation and can only populate places within restricted distance range.**
